...
public class DatabaseHandler {
                ...
                .addOnCompleteListener(c, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            new ShowLoadingScreen().showDialog(c, SignInPage.class);
                        }
                        else {
                            try{
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (user != null) {
                                ...
                                new FetchCurrentUser().getUserFromDatabase(user.getEmail());
                                new ShowLoadingScreen().showDialog(c, MainContent.class);
                            } else {
    ...
    public void Logout(Activity c){
        mAuth.signOut();
        new ShowLoadingScreen().showDialog(c,MainActivity.class);
    }
}
